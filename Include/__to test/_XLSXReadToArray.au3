...
;~ MsgBox(48,"_XLSXReadToArray","Error Handle deaktiviert, Plan ist ein COM Error handler")
If Not ObjEvent("AutoIt.Error") Then 
	Global Const $_XLSXZip_COMErrorFunc = ObjEvent("AutoIt.Error", "_XLSXZip_COMErrorFunc")
EndIf
